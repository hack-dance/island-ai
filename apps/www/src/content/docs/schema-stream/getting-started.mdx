...
The SDK integrations below are structural and add no SDK runtime or peer dependency. Release fixtures compile the packed package against `@openai/agents@0.13.1` and `ai@6.0.222`.
