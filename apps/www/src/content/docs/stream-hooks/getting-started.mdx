...
`stream-hooks` follows `zod-stream`'s current Zod 3 boundary and supports Zod 3.25 and newer 3.x releases. Use `schema-stream` directly for Zod 4 schema streaming.
