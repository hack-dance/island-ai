...
`zod-stream` currently supports Zod 3.25 and newer 3.x releases. Its response-model JSON Schema conversion does not accept Zod 4 schemas; `schema-stream` itself supports both Zod 3 and Zod 4.
