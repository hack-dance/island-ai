...
`zod-stream` adds structured output validation and streaming capabilities to LLM responses. Built on top of [`schema-stream`](https://github.com/hack-dance/schema-stream), it enables type-safe extraction with progressive validation.
