export async function BadgeLogo({ size = 64 }) {
  return (
    <svg width={size} height={size} viewBox="0 0 851.38 851.38">
      <g>
        <circle className="fill-[#242420] dark:fill-[#e1ddd7]" cx="425.69" cy="425.69" r="425.69" />
        <circle
          className="stroke-[#e1ddd7] dark:stroke-[#242420] fill-none"
          strokeWidth={12}
          cx="425.69"
          cy="425.69"
          r="390.01"
        ...
        <g>
          <rect
            className="fill-[#e1ddd7] dark:fill-[#242420]"
            x="411.91"
            y="285.1"
            width="33.1"
            height="56.2"
